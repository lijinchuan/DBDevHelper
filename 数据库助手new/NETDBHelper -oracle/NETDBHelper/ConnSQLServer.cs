...
namespace NETDBHelper
{
    public partial class ConnSQLServer : Form
    {
        ...
        public ConnSQLServer()
        {
            ...
            if (dbs.Count > 0)
            {
                this.cb_db.DataSource = dbs.Select(p => new { key = p.DBName, value = p.DBName }).ToList();
                this.cb_db.DisplayMember = "value";
                this.cb_db.ValueMember = "key";
                this.cb_db.SelectedIndex = 0;
            }
        ...
        {
            //panel_yz.Enabled = this.cb_db.SelectedValue.ToString()=="2";
        }
