...
namespace Nonamespace
{
    public class NewsEntity
    {
        ...
        <span style='color:blue;'>[DBFieldMapAttribute(IsKey=true,IsIdentity=true,Nullable=false,Description=" + "\"自增主键\"" + @")]</span>
        public int Id
        {
            get
            {
        ...
        private long _isImp;
        <span style='color:blue;'>[DBFieldMapAttribute(Len=0)]</span>
        public long IsImp
        {
            get
            {
